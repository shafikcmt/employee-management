...
<div class="attendance-list-page space-y-4">
        ...
        <div class="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            ...
            <form method="get" class="grid gap-3 md:grid-cols-[260px_190px_160px] md:items-end">
                ...
                <div>
                    ...
                    <input class="field mt-1" type="date" name="date" value="<?php echo e($date->toDateString()); ?>">
                </div>
    ...
    <form method="post" action="<?php echo e(route('attendance.bulk-store')); ?>" id="attendanceForm" class="space-y-4">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="attendance_date" value="<?php echo e($date->toDateString()); ?>">
        ...
        <div class="page-card p-4">
            <div class="grid gap-3 xl:grid-cols-[1fr_auto] xl:items-center">
                <div>
                    <h2 class="text-xl font-black text-slate-950"><?php echo e($date->format('l, d M Y')); ?></h2>
                    <p class="mt-1 text-sm text-slate-500"><?php echo e($employees->count()); ?> active employee(s) loaded.</p>
                </div>
            ...
            <div class="mt-4 grid gap-2 md:grid-cols-5">
                <div class="summary-box"><div class="text-xs font-black uppercase text-slate-400">Total</div><div class="text-2xl font-black" id="statTotal"><?php echo e($employees->count()); ?></div></div>
                ...
                <div class="summary-box"><div class="text-xs font-black uppercase text-slate-400">Visible</div><div class="text-2xl font-black" id="visibleCountTop"><?php echo e($employees->count()); ?></div></div>
            </div>
        </div>
            ...
            <div class="attendance-table-wrap">
                <table class="attendance-table" id="attendanceTable">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="attendance-row <?php echo e($currentStatus === 'present' ? 'is-present' : ''); ?> <?php echo e($currentStatus === 'absent' ? 'is-absent' : ''); ?> <?php echo e($isExtra ? 'is-extra' : ''); ?>" data-search="<?php echo e($searchText); ?>" data-row-status="<?php echo e($currentStatus); ?>" data-extra="<?php echo e($isExtra ? '1' : '0'); ?>">
                            <td>
                                <span class="mobile-label">No</span>
                                <span class="font-black text-slate-500"><?php echo e($index + 1); ?></span>
                                <input type="hidden" name="employee_ids[]" value="<?php echo e($employee->id); ?>">
                                <select name="status[<?php echo e($employee->id); ?>]" class="status-select hidden">
                                    <?php $__currentLoopData = ['empty'=>'Empty','present'=>'Present','absent'=>'Absent','friday'=>'Friday','public_holiday'=>'Public Holiday','not_working'=>'Not Working']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php if($currentStatus === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </td>
                            <td>
                                <span class="mobile-label">Employee</span>
                                <div class="employee-name"><?php echo e($employee->name); ?></div>
                                <div class="employee-meta">
                                    Iqama: <b><?php echo e($employee->iqama_no ?: '-'); ?></b>
                                    · <?php echo e(optional($employee->designation)->name ?: 'No designation'); ?>

                                    · Project: <?php echo e(optional($employee->currentProject)->name ?: '-'); ?>

                                </div>
                                <div class="mt-1 flex flex-wrap gap-1">
                                    <span class="status-label pill pill-muted"><?php echo e(ucfirst(str_replace('_',' ', $currentStatus))); ?></span>
                                    <span class="extra-label pill pill-extra <?php echo e($isExtra ? '' : 'hidden'); ?>">Extra Duty</span>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <input class="small-input hours-input" type="number" step="0.01" min="0" name="hours[<?php echo e($employee->id); ?>]" value="<?php echo e(optional($record)->hours); ?>" placeholder="8" oninput="hoursChanged(this)">
                            </td>
                            <td>
                                ...
                                <label class="inline-flex cursor-pointer items-center gap-2 font-bold text-amber-800">
                                    <input class="extra-checkbox h-4 w-4" type="checkbox" name="is_extra_duty[<?php echo e($employee->id); ?>]" value="1" <?php if($isExtra): echo 'checked'; endif; ?> onchange="extraChanged(this)">
                                    Extra
                                </label>
                            </td>
                            <td>
                                <span class="mobile-label">Rate</span>
                                <input class="small-input rate-input" type="number" step="0.01" min="0" name="rate[<?php echo e($employee->id); ?>]" value="<?php echo e($rate); ?>" placeholder="0">
                            </td>
                            <td>
                                <span class="mobile-label">Duty Type</span>
                                <select name="extra_duty_type[<?php echo e($employee->id); ?>]" class="small-input duty-type-input">
                                    <?php $__currentLoopData = ['friday'=>'Friday Duty','public_holiday'=>'Public Holiday','off_day'=>'Off Day','normal_day'=>'Normal Overtime']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>" <?php if((optional($record)->extra_duty_type ?? ($isFriday ? 'friday' : 'normal_day')) === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </td>
                            <td>
                                <span class="mobile-label">Remarks</span>
                                <input class="small-input" name="remarks[<?php echo e($employee->id); ?>]" value="<?php echo e(optional($record)->remarks); ?>" placeholder="Optional note">
                            </td>
                        </tr>
            ...
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <div class="text-xs text-slate-500">
                        Visible: <b id="visibleCount"><?php echo e($employees->count()); ?></b>, Present: <b id="savePresent">0</b>, Absent: <b id="saveAbsent">0</b>, Extra: <b id="saveExtra">0</b>
                    </div>
                </div>
                <div class="flex flex-wrap gap-2">
                    <a class="btn" href="<?php echo e(route('attendance.index', ['project_id' => $projectId, 'month' => $date->month, 'year' => $date->year])); ?>">Monthly Sheet</a>
                    <a class="btn" href="<?php echo e(route('absent.index', ['project_id' => $projectId, 'month' => $date->month, 'year' => $date->year])); ?>">Absent Report</a>
...
<script>
const isFriday = <?php echo json_encode($isFriday, 15, 512) ?>;
